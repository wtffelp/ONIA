...
extern ProfileOptions_TraceOptionsDefaultTypeInternal _ProfileOptions_TraceOptions_default_instance_;
...
template<> ::tensorflow::ProfileOptions_TraceOptions* Arena::CreateMaybeMessage<::tensorflow::ProfileOptions_TraceOptions>(Arena*);
...
class ProfileOptions_TraceOptions final :
